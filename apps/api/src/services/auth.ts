        ...
        if (user.mfaEnabled && user.mfaSecret) {
            return {
                ...
                user: {
                    ...
                    theme: user.theme,
                    mfaEnabled: true,
                    mobileNavItems: Array.isArray(user.mobileNavItems) ? user.mobileNavItems : undefined,
    ...
    static async refresh(refreshTokenStr: string) {
        ...
        return {
            ...
            user: {
                ...
                mobileNavItems: Array.isArray(stored.user.mobileNavItems) ? stored.user.mobileNavItems : undefined,
                ...
                featureFood: !!stored.user.featureFood,
