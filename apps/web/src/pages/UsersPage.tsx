...
import { Users, Plus, X, Shield, UserCheck, UserX } from 'lucide-react';
...
export default function UsersPage() {
    ...
    const createMut = useMutation({
        ...
        onSuccess: () => { qc.invalidateQueries({ queryKey: ['users'] }); setShowCreate(false); setForm({ name: '', email: '', password: '', role: 'USER' }); },
    });
